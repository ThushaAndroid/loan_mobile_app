...
import 'package:credit_app/old_payment_screen.dart';
                            ...
                            child: Container(
                              child: StreamBuilder<QuerySnapshot>(
                                stream: FirebaseFirestore.instance
                                    .collection('cre_loan').doc(nic).collection('loan_no')
                                    .snapshots(),
                                           ...
                                           return Card(
                                            child: ListTile(
                                             title: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text('Loan no = '+docs[index]['Loan no'].toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15)),
                                                Text('Duration = '+docs[index]['Duration'],style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15)),
                                                Text('Total = Rs.'+docs[index]['Total'].toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15)),
                                                Text('Balance = Rs.'+docs[index]['Balance'].toString(),style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15))
                              
                                              ],
                                             ),
                                             onTap: (){
                                             var lNo=docs[index]['Loan no'].toString();
      
                                                Navigator.of(context).push(MaterialPageRoute(
                                                                          builder: (_) => OldPayment(widget.name,widget.nic,lNo),
                                                               ));
                                             },       
                                            ),
                                           );
                         ...
                         child:   GestureDetector(
                                              ...
                                              Navigator.pop(context);
                                                                   ...
                                                                   Navigator.of(context).pushReplacement(MaterialPageRoute(
                                                                          builder: (_) => LoanPayment(widget.name,widget.nic,widget.maxValue,widget.date,widget.model),
                                                               ));
