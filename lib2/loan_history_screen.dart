...
LoanHistory(String name, String nic, String receptNo, List model){
                                         ...
                                         return Card(
                                          child: ListTile(
                                           ...
                                           onTap: (){
                                            ...
                                            var tot=docs[index]['loan_total'].toString();

                                              Navigator.of(context).pushReplacement(MaterialPageRoute(
                                                                        builder: (_) => LoanPayment(widget.name,widget.nic,type,dur,tot,maxValue,date,widget.model),
                                                             ));
                                           },       
                                          ),
                                         );
