...
class BottomSheets extends StatefulWidget {
  ...
  late var balance;
   ...
   BottomSheets(String name,String nic,String type,String dur,String tot, int maxValue, String date,var balance){
          ...
          child: Column(
            children: [
              ...
              TextButton(
                                              ...
                                              setState(() {
                                                ...
                                                if(_formKeyAmount.currentState!.validate()){
                                                    cAmount=double.parse(amount.text);
                                                     model.add(ListModel(amount:double.parse(amount.text), rate:rate , time:currentDate));
                                            ...
                                            final newDocument2=FirebaseFirestore.instance.collection('cre_recept').doc(date+'  '+maxValue.toString()).collection('time').doc(currentDate);
