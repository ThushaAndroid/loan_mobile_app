...
class LoanPayment extends StatefulWidget {
  ...
  LoanPayment(String name,String nic,String type,String dur,String tot, int maxValue, String date, List model){
  ...
  print('Error getting document: $error');
    ...
    void bottomSheet(BuildContext ctx){
       showModalBottomSheet(isScrollControlled: true,context: ctx, builder: (_){
          return BottomSheets(widget.name,widget.nic,widget.type,widget.dur,widget.tot,widget.maxValue,widget.date,balance); 
       },);
    } 
  @override
                    ...
                    child:TextButton(
                                          onPressed: ()async{                                       
                                           Navigator.of(context).pushReplacement(MaterialPageRoute(
                                                                          builder: (_) => LoanHistory(name,nic,'',widget.model),
                                                               ));
                                          }, 
                                          child: Text('Another payment',style: TextStyle(fontSize: 18),), 
                                                       style: TextButton.styleFrom(
                                                      foregroundColor: Colors.white,
                                                      elevation: 2,
                                                      backgroundColor: Colors.blue),
